      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 py-32 md:px-10 md:py-44">
        ...
        <Reveal y={28}>
          <div className="max-w-2xl rounded-[1.8rem] border border-white/70 bg-white/85 p-7 shadow-[0_36px_80px_-40px_rgba(58,36,64,0.35)] backdrop-blur-md md:p-10">
            ...
            {/* 只留她点名的两件事：conversations，和志同道合的人。
                方向由正下方那排标签讲（写的就是同样六个），这里不重复。
                字越少越撑得起大字号，逐词点亮也才看得出来。 */}
            <ScrollLit
              className="mt-7 text-[19px] leading-relaxed md:text-[22px]"
              from={8}
              to={70}
              text="Open to conversations — and to friends who care about the same things."
            />
          </div>
        </Reveal>
