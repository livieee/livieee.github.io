...
export function ProgramWall() {
  ...
  return (
    <Link
      ...
      className="wall-board group/wall relative block aspect-[2/1] w-full cursor-none overflow-hidden rounded-[1.4rem] bg-gradient-to-br from-lavender/45 via-cream-soft to-blush/30"
      onPointerMove={(e) => {
